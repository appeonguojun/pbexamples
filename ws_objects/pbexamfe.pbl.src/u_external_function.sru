...
$PBExportComments$クロス プラットフォーム ユーザ オブジェクトの先祖オブジェクト
forward
...
//////////////////////////////////////////////////////////////////////////////
//
//	Copyright © 1996-1997 SAP AG and its subsidiaries.  All rights reserved.
//	Any distribution of the PowerBuilder Foundation Classes (PFC)
//	source code by other than SAP AG and its subsidiaries is prohibited.
//
//////////////////////////////////////////////////////////////////////////////
...
If Not FileExists ( ls_ExampleDir + ls_anchorFile ) Then
	If MessageBox ("警告", "Code Examples の実行に必要なビットマップおよびアイコンリソースを含むフォルダが見つかりません。" + &
								"通常、 PowerBuilder メインフォルダには 'examples' というサブフォルダが存在します。~n~r~n~r" + &
								"次の画面でフォルダの設定が行えます。~n~r~n~r" + &
								"今すぐフォルダの設定を行いますか？", Exclamation!, YesNo!, 2) = 2 Then

		Return
	Else
		// Allow the user to find the directory
		If GetFileOpenName("Examplesフォルダを選択してください。", ls_ExampleDir, ls_File) = 1 Then
