...
$PBExportComments$アプリケーション システム エラー イベントで用いられる一般的なエラー ウィンドウ
forward
...
print    (ll_prt, "システムエラーメッセージ - "+string(today())+" - "+string(now(), "HH:MM:SS"))
print    (ll_prt, " ")

ls_line = "エラー番号          : " + getitemstring(dw_error,1,1)
print    (ll_prt, ls_line)

ls_line = "エラーメッセージ    : " + getitemstring(dw_error,1,2)
print    (ll_prt, ls_line)

ls_line = "ウィンドウ/メニュー : " + getitemstring(dw_error,1,3)
print    (ll_prt, ls_line)

ls_line = "オブジェクト        : " + getitemstring(dw_error,1,4)
print    (ll_prt, ls_line)

ls_line = "イベント            : " + getitemstring(dw_error,1,5)
print    (ll_prt, ls_line)

ls_line = "行番号              : " + getitemstring(dw_error,1,6)
print    (ll_prt, ls_line)
