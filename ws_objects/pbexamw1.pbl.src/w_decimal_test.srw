...
$PBExportComments$いろいろな数値データの表示と切り詰め
forward
...
choose case ls_operator
	...
	case '/'
		...
		if lc_op2 = 0 then
			MessageBox ('エラー', '0による除算はできません', exclamation!)
			em_2.SetFocus()
...
long backcolor = 74481808
boolean enabled = false
string text = "宣言されているタイプで結果が表示されます。"
boolean focusrectangle = false
end type
...
long backcolor = 74481808
boolean enabled = false
string text = "2 つの値と演算子を入力してください。"
boolean focusrectangle = false
end type
