...
$PBExportComments$再帰処理やツリービュー コントロールの使い方を示すディレクトリ ツリー サンプル プログラム
forward
...
event open;call super::open;Choose Case ge_Environment.OSType
	...
	Case Sol2!, HPUX!, AIX!
		...
		st_1.text = "スキャンを開始するディレクトリを入力し、スキャン ボタンをクリックしてください。"
...
long backcolor = 77643992
boolean enabled = false
string text = "スキャンを行うディレクトリを選択し、スキャン ボタンをクリックしてください。"
boolean focusrectangle = false
end type
