...
$PBExportComments$データ マネージャ (プログラム マネージャ - ListViews スタイル)
forward
...
Choose Case ai_Level
	Case 1
		...
		lv_1.AddColumn("部署ID", Left!, 150)
		lv_1.AddColumn("管理者", Left!, 235)
		lv_1.AddColumn("勤務状況", Center!, 175)
...
Choose Case ii_Level
	Case 1
		This.Title = "販売レポート"
	Case 2
		This.Title = "営業担当者: " + ls_Label
	Case 3
		This.Title = "受注: " + ls_Label
	Case 4
		This.Title = "受注項目:  " + ls_Label
End Choose
