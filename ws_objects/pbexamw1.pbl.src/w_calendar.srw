...
$PBExportComments$ユーザ オブジェクト ドロップダウン カレンダーのデモ
forward
...
string text = "ドロップダウン カレンダー ユーザ オブジェクト"
...
long backcolor = 74481808
boolean enabled = false
string text = "ユーザ オブジェクトのドロップダウン ボタンをクリックすると、ドロップダウン カレンダーが表示されます。"
boolean focusrectangle = false
end type
...
string item[] = {"yyyy/mm/dd","[LongDate]","[ShortDate]","mmm-yy","dddd, mmm d, yyyy","mm/dd/yyyy","mm/dd/yy","yyyy-mm-dd","yy/mmm","yy/mm/dd"}
