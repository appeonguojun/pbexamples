...
$PBExportComments$ウィンドウの先祖グラフをメンテナンス
forward
...
for li_index = 1 to li_row
	if this.title = "顧客別統計" then
		gr_1.adddata ( 1, dw_1.getitemnumber (li_index, 2), &
						GetItemString (dw_1, li_index, 6 ))
	else	
	gr_1.adddata ( 1, dw_1.getitemnumber (li_index, 2), &
...
Category.DispAttr.FaceName="ＭＳ Ｐゴシック"
...
Category.LabelDispAttr.FaceName="ＭＳ Ｐゴシック"
...
Values.DispAttr.FaceName="ＭＳ Ｐゴシック"
...
Values.LabelDispAttr.FaceName="ＭＳ Ｐゴシック"
...
Series.DispAttr.FaceName="ＭＳ Ｐゴシック"
...
LegendDispAttr.FaceName="ＭＳ Ｐゴシック"
