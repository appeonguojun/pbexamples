...
$PBExportComments$マルチラインエディット テキストの様々なスクロールバーとオートスクロール属性の動作
forward
...
string Title="マルチラインエディットの自動スクロール"
...
is_mletext = "マルチラインエディットボックスです。" + &
"右のチェックボックスのチェックを切り替えることで、属性を変更することができます"+ &
"スクロールバーの属性と、自動スクロールの属性に注目してください。"
...
string Text="それぞれのマルチラインエディット ボックスに文字を入力して下さい。"
