...
$PBExportComments$ガベージ コレクション サンプル ウィンドウ
forward
...
MessageBox("メモリ リーク", "元の値:~t" + is_OriginalMemory + "~n~r現在値:~t" + st_mem.Text + &
					"~n~r~n~r差:~t" + String(of_long_mem(is_OriginalMemory) - of_long_mem(st_mem.Text), "#,###,##0") + " bytes")
