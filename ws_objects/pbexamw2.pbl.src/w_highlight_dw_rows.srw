...
$PBExportComments$マウスのクリックとシフトもしくはコントロール キーのコンビネーションにより、データウィンドウの行をハイライト表示にする方法
forward
...
string Text="このサンプルではファイルマネージャと同様の方法で複数行を選択するメソッドの例を示します。詳細はヘルプを参照してください。"
