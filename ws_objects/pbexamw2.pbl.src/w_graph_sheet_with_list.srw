...
$PBExportComments$w_graph_sheetからの継承; リストからのカテゴリーと値の選択機能を追加したウィンドウ
forward
...
this.Control[iCurrent+1]=this.lb_category
this.Control[iCurrent+2]=this.lb_value
...
boolean Enabled=false
boolean BringToTop=true
string Text="値をデータウィンドウからグラフ オブジェクトへ代入します。"
