...
$PBExportComments$PB 7 トラックバー コントロール
forward
...
dw_1.Title = "倍率: " + String ( this.Position ) + "%"
end event
...
long textcolor = 33554432
long backcolor = 67108864
string text = "トラックバーを動かすとデータウィンドウの倍率を変更できます。"
boolean focusrectangle = false
end type
