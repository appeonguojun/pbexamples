...
$PBExportComments$オブジェクトの印刷とスクリーンの印刷機能を使用しています。
forward
...
ll_Job = PrintOpen()
If ll_Job = -1 Then
	Messagebox("印刷エラー","印刷ジョブを開けませんでした。プリンタの設定とプリント マネージャを確認して下さい。")
	Return
End If
...
If ll_Job = -1 Then
	Messagebox("印刷エラー","印刷ジョブを開けませでした。プリンタの設定とプリント マネージャを確認して下さい。")
	Return
End If
