...
$PBExportComments$商品のリストビュー、 w_add_sales_order で使用します。
forward
...
string text = "商品をドラッグ アンド ドロップして受注項目を追加してください。商品をダブルクリックすると、商品情報を表示することができます。ポップアップ メニューを使用して、表示を変更することができます。"
