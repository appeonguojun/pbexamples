...
$PBExportComments$全件検索と該当項目だけを検索する場合のパフォーマンス比較
forward
...
if itr_trans.SQLCode = -1 then
	MessageBox ("エラー", "接続に失敗しました", exclamation!)
...
int Height=71
boolean Enabled=false
string Text="必要な行だけを検索したデータウィンドウ:"
boolean FocusRectangle=false
long TextColor=41943040
long BackColor=74481808
int TextSize=-9
...
int Height=71
boolean Enabled=false
string Text="すべての行を検索したデータウィンドウ:"
boolean FocusRectangle=false
long TextColor=41943040
long BackColor=74481808
int TextSize=-9
