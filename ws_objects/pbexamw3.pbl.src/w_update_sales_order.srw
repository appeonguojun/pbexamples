...
$PBExportComments$rowfocuschanging イベントの使用例
forward
...
If ib_SaveNeeded Then
	li_RC = MessageBox("警告", "データは変更されています。終了する前に変更を保存しますか？", Question!, YesNoCancel!, 1)
	If li_RC = 1 Then
