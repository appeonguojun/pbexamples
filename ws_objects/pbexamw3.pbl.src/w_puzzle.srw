...
If Not lb_Wrong Then
	Timer(0)
	MessageBox("おめでとうございます！",st_time.Text + " 秒でクリアしました！")
	ib_Solving = False
	st_inst.Text = "~"スタート~" ボタンをクリックして開始してください。"
End if
...
boolean enabled = false
string text = "<スタート> ボタンをクリックして開始してください。"
...
Hide(p_logo)
st_inst.Text = "パズルのピースをドラッグ アンド ドロップしてください。"
