...
$PBExportComments$ツールバーの新機能をテストするためのシート ウィンドウ
forward
...
This.Title = "ツールバー機能テスト シート #" + String(lw_Frame.ii_SheetNum)
...
event closequery;If of_IsLastSheet() Then
	...
	If MessageBox("ツールバー機能テスト", "シートを閉じる前にツールバーの設定を保存しますか?", &
