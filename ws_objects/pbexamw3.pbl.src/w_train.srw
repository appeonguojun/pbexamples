...
$PBExportComments$電車が音を立てて進むあいだアニメーションを用いて表示
forward
...
// Put a 2second limit on how slow it can go
	If (ir_timer_interval <= .091 ) Then
		...
		st_timer_interval.text = "Timer イベント発生間隔: "+String(ir_timer_interval,"0.00") + " 秒"
	Else
...
st_timer_interval.text = "タイマー オフ"
