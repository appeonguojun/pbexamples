...
$PBExportComments$実行時にデータベースから入手したデータをドロップダウンリストボックスに追加します。
forward
...
string title = "データベースから DropDownListBox へのデータ取込"
...
int Height=116
boolean Enabled=false
string Text="選択したテーブルのカラムのデータをドロップダウン リストボックスに表示します。"
boolean FocusRectangle=false
long TextColor=41943040
long BackColor=74481808
int TextSize=-9
...
int Height=72
boolean Enabled=false
string Text="ドロップダウン リストボックスにデータベースの内容を表示します。"
boolean FocusRectangle=false
long TextColor=41943040
long BackColor=74481808
int TextSize=-9
...
if li_ret <> 0 then
	MessageBox("エラー", sqlca.sqlerrtext)
else
