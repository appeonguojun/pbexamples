...
$PBExportComments$データウィンドウを共有しているグラフ
forward
...
string Title="共有データウィンドウを使用したグラフ"
...
IF li_rc <> 1 THEN MessageBox("データウィンドウ共用エラー",li_rc)
