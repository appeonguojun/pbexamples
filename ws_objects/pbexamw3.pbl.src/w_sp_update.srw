...
$PBExportComments$ストアドプロシージャによるデータウィンドウ更新のサンプル
forward
...
integer width = 2340
integer height = 1124
string title = "ストアドプロシージャによるデータウィンドウ更新"
...
if ll_cur_row > 0 then
	...
	if MessageBox ("確認", ls_last_name + " " + ls_first_name + " をコンタクトから削除しますか？", question!, yesno!) = 1 then
