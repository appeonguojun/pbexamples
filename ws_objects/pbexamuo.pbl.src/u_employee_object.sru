...
if al_row > 0 and al_row <= idw_parm.RowCount() then
	...
	if le_status <> new! and le_status <> newmodified! then	
		...
		if MessageBox ("確認", ls_last_name + 	" " + ls_first_name + " を削除しますか？", question!, yesno!) = 2 then
			return 0
		end if		
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if MessageBox ("新規従業員作成", "新しい従業員を登録しますか？", question!, yesno!) = 1 then
